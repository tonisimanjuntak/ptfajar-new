...
class Pengguna_model extends CI_Model {
    ...
    var $column_order = array(null,'namapengguna','tempatlahir','nomorhp','username', null);
    var $column_search = array('namapengguna','jeniskelamin','nomorhp','tempatlahir','tgllahir','email','fotouser','username','password');
