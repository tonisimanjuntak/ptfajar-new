...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo $this->session->userdata('logoperusahaan'); ?>" />

  <title><?php echo strtoupper($this->session->userdata('namaperusahaan')); ?></title>
