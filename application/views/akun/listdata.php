    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          ...
          <a href="<?php echo(site_url('Akun/importexcel')) ?>" class="btn btn-sm btn-success float-right mr-2"><i class="fa fa-cloud-upload-alt" target="_blank"></i> Upload Excel</a>
        </div>
        <div class="card-body">
          <div class="row">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-primary" style="">
                      ...
                      <th style="text-align: center;">Parent Akun</th>
