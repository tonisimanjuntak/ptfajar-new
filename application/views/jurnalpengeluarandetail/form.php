...
<div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Jurnalpengeluarandetail</h4>
    </div>  
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="<?php echo(site_url()) ?>">Home</a></li>
        <li class="breadcrumb-item"><a href="<?php echo(site_url('Jurnalpengeluarandetail')) ?>">Jurnalpengeluarandetail</a></li>
  ...
  <div class="row" id="toni-content">
    <div class="col-md-12">
      <form action="<?php echo(site_url('Jurnalpengeluarandetail/simpan')) ?>" method="post" id="form">                      
        <div class="row">
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row required">
                    <label for="" class="col-md-3 col-form-label">idjurnalpengeluaran</label>
                    <div class="col-md-9">
                      <input type="text" name="idjurnalpengeluaran" id="idjurnalpengeluaran" class="form-control" placeholder="Masukkan idjurnalpengeluaran">
                    </div>
                  </div>                      
                  <div class="form-group row required">
              ...
              <div class="card-footer">
                ...
                <a href="<?php echo(site_url('Jurnalpengeluarandetail')) ?>" class="btn btn-default float-right mr-1 ml-1"><i class="fa fa-chevron-circle-left"></i> Kembali</a>
              </div>
            </div> <!-- /.card -->
          </div> <!-- /.col -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    if (  != "" ) { 
          $.ajax({
              type        : 'POST', 
              url         : '<?php echo site_url("Jurnalpengeluarandetail/get_edit_data") ?>', 
              data        : {: }, 
              dataType    : 'json', 
              encode      : true
          })      
          ...
          $("#lbljudul").html("Edit Data Jurnalpengeluarandetail");
          $("#lblactive").html("Edit");

    }else{
          $("#lbljudul").html("Tambah Data Jurnalpengeluarandetail");
