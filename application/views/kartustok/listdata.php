...
?>
  ...
  <div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Kartu Stok</h4>
    </div>  
    <div class="col-6">
...
<script type="text/javascript">
    ...
    $('#btnCetakPdf').click(function(e){
        ...
        window.open("<?php echo site_url('kartustok/cetak/pdf/') ?>" + tglawal + "/" + tglakhir + "/" + kodeakun  + "/Lap Kartu Stok");
    });
    ...
    $('#btnCetakExcel').click(function(e){
        ...
        window.open("<?php echo site_url('kartustok/cetak/excel/') ?>" + tglawal + "/" + tglakhir  + "/" + kodeakun + "/Lap Kartu Stok");
