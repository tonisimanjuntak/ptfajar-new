    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          ...
          <a href="<?php echo(site_url('Penandatangan/tambah')) ?>" class="btn btn-sm btn-primary float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-primary" style="">
                      ...
                      <th style="text-align: center;">namapenandatangan</th>
                      <th style="text-align: center;">nip</th>
                      <th style="text-align: center;">jabatan</th>
                      <th style="text-align: center;">statusaktif</th>
