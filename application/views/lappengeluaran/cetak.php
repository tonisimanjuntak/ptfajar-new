        ...
        <tbody>
            <tr>
                ...
                <td style="width:50%; text-align:center;">
                    <span style="">LAPORAN PENGELUARAN</span><br>
...
if ($rslaporan->num_rows() > 0) {
    ...
    foreach ($rslaporan->result() as $row) {
        ...
        if ($idpengeluaran_old != $row->idpengeluaran) {
            
            $table .='          
                    <tr>
                        <td style="font-size:11px; text-align:center;" width="5%">'.$no++.'</td>
                        <td style="font-size:11px; text-align:center;" width="15%">'.tglindonesia($row->tglpengeluaran).'</td>
                    ...
                    <tr>
                        ...
                        <td style="font-size:11px; text-align:right;" width="15%">'.format_rupiah($row->hargajual).'</td>
        ...
        $idpengeluaran_old = $row->idpengeluaran;
